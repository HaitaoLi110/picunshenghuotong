...
Page({
                        ...
                        success: function(t) {
                            if (t.confirm) if (console.log("用户点击确定"), e <= 0) console.log("免费刷新"), app.util.request({
                                ...
                                success: function(t) {
                                  ...
                                  if  (console.log(t), 1 == t.data ) (wx.showToast({
                                        title: '刷新成功'
                                    }), setTimeout(function() {
                                        wx.reLaunch({
                                            url: "../index/index"
    ...
    selected: function(t) {
        var e = this, a = this.data.countryIndex, o = t.currentTarget.id, n = wx.getStorageSync("openid"), s = wx.getStorageSync("users").id, i = e.data.stick, 
       // c = 0 == a ? i[o].money : i[o].money2,
        ...
        wx.showModal({
            ...
            iszd: !1,
            xzdq: !1
        }), console.log(c,  l), Number(c) <= 0) app.util.request({
    ...
    onPullDownRefresh: function() {
        this.setData({
            ...
            postlist: [],
            page: 1
        }), this.reload(), this.tabClick(this.data.clickE), wx.stopPullDownRefresh();
    },
