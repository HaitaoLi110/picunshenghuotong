var app = getApp(), util = require("../../utils/comme.js");
...
Page({
    ...
    onLoad: function(t) {
		...
		app.util.request({
					 url: "https://picunshenghuo.hqkjbj.com/app/index.php?i=2&c=entry&a=wxapp&do=MbInfo&m=zh_tcwq",
					 
					 data: {
					    type:1 
					 },
					 success: function(e) {
						wx.setStorage({ key:"tempID",
						data:e })
					 }
		})
